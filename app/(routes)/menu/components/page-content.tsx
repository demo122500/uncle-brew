    ...
    <>
            ...
            {currentParams &&
              Object.entries(currentParams).map(([key, value]) => (
                ...
                <div
                  ...
                  className="w-fit px-4 py-1 cursor-pointer hover:shadow-md rounded-md bg-emerald-500/10 text-neutral-600 flex items-center gap-1"
                >
                  {value}
                  <X className="w-4 h-4" />
                </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 w-full h-full gap-4 gap-y-24">
        {products.length > 0 ? (
          ...
          <>
            <Box className="items-center text-center justify-center py-12 text-muted-foreground text-xl font-bold col-span-10">
