    ...
    <div>
      ...
      <div className="mt-3 flex items-end justify-between">
        <p className="text-base text-left text-neutral-600">
          ...
          repellat blanditiis! Accusamus dignissimos sit iure dicta facere, sint
          magnam delectus. Blanditiis vel nihil debitis repellendus iure? Nam
          perferendis inventore atque!
        </p>
      </div>
      ...
      <div className="w-full flex items-center justify-start gap-2 flex-wrap px-2 mt-8">
        {product.cuisine && (
          <div className="rounded-md bg-emerald-500/10 px-3 py-2 text-base font-semibold capitalize flex items-center gap-2">
            <CookingPot className="w5 h-5" />
            {product.cuisine}
          </div>
        )}

        {product.category && (
          <div className="rounded-md bg-emerald-500/10 px-3 py-2 text-base font-semibold flex items-center capitalize gap-2">
        ...
        {product.size && (
          <div className="rounded-md bg-emerald-500/10 px-3 py-2 text-base font-semibold flex items-center capitalize gap-2">
            <SquareActivity className="w5 h-5" />
            {product.size}
          </div>
        )}
      </div>
